        ...
        <font size="-2"><i>NMT Community Software Installer for web. CSI Lite version <?php echo $aSettings['VERSION']; ?>. Created by Ger Teunis &amp; Jeroen Seegers.</i> (PCH <?php echo $aSettings['DEVICE_TYPE']; ?>)</font>
